...
set jeton(bonus) {6 4}
set jeton(owner) ""
set jeton(desc)  "6 pieces d'or + 4 PV"
lappend JETONS [array get jeton]
...
set jeton(bonus) {0 0}
set jeton(owner) ""
set jeton(desc)  "Recuperer l'or depense par l'adversaire lors du commerce"
lappend JETONS [array get jeton]
...
set jeton(bonus) {0 0}
set jeton(owner) ""
set jeton(desc)  "Gagner par la science avec 5 cartes vertes differentes au lieu de 6"
lappend JETONS [array get jeton]
...
set jeton(bonus) {0 0}
set jeton(owner) ""
set jeton(desc)  "Rejouer apres la construction des merveilles"
lappend JETONS [array get jeton]
...
set jeton(bonus) {6 0}
set jeton(owner) ""
set jeton(desc)  "6 pieces d'or + 4 pieces d'or pour chaque carte construite par chainage"
lappend JETONS [array get jeton]
