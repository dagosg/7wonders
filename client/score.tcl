...
proc SCORE_UpdateScore {} {
  ...
  if { $game_state(round) != 4 } {
    ...
    .board.score.c delete img_score txt_score
    ...
    SCORE_DisplayTxt $game_state(player_first)  0 [string range $game_state(player_first)  0 9]
    SCORE_DisplayTxt $game_state(player_second) 0 [string range $game_state(player_second) 0 9]
